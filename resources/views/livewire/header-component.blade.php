<div class="header-container fixed-top">
    <header class="header navbar navbar-expand-sm">
            ...
            {{-- <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown  custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/img/ca.png"
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" aria-labelledby="customDropdown">
                        <a class="dropdown-item" data-img-value="de" data-value="German" href="javascript:void(0);"><img
                                src="assets/img/de.png" class="flag-width" alt="flag">
                            German</a>
            ...
            <li class="nav-item dropdown notification-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="notificationDropdown"
                    ...
                    @if (auth()->user()->profile == 'ADMIN')
                        @foreach ($solicitudesPendientes as $solicp)
                            @if ($solicp->visto_Admin == 'NO')
        ...
        @if (auth()->user()->profile == 'ADMIN' || auth()->user()->profile == 'STUDENT')
            <div class="dropdown-menu position-absolute animated fadeInUp"
                ...
                @if (auth()->user()->profile == 'ADMIN')
                    <div class="notification-scroll">
                        @foreach ($solicitudesPendientes as $solicp)
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <a wire:click="vistoAdmin({{ $solicp->id }})">
                                        <div class="media-body">
                                            @if ($solicp->visto_Admin == 'NO')
                                            ...
                                            @endif
                                            <div class="data-info">
                                                <h6 class="">Solicitud de pago</h6>
                                                <h6 class="">{{ $solicp->estado }}</h6>
                                                <p>{{ $solicp->nombre_solicitante }}</p>
                                                <p class="">
                                                    {{ \Carbon\Carbon::parse($solicp->created_at)->format('d/m/Y H:i') }}
                                                </p>
                                            </div>
                        ...
                        <div class="dropdown-item">
                            <div class="media file-upload">
                                <a href="{{ url('solicitudesPagos') }}">
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Ver todas las solicitudes</h6>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                @if (auth()->user()->profile == 'STUDENT')
                    <div class="notification-scroll">
                        @forelse ($solicitudesPendientes as $solicp)
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <a
                                        wire:click="vistoStudent({{ $solicp->id }},{{ $solicp->pago->alumno_horario->horario_id }})">
                                        <div class="media-body">
                                            @if ($solicp->visto_Student == 'NO')
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        @empty
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">No hay notificaciones aún</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="media mx-auto">
                    ...
                    <div class="media-body">
                        ...
                        @elseif (auth()->user()->profile == 'ADMIN')
                            <h5>{{ auth()->user()->admin->nombre }}</h5>
                        @else
                            <h5>{{ auth()->user()->alumno->nombre }}</h5>
                        @endif
