<x-modal id="theModal">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="time" wire:model.lazy="hora_inicio" {{ $professor_id == 'Elegir' ? 'disabled' : '' }}>
                    @error('hora_inicio')
                    <span class="text-danger er">{{ $message }}</span>
                    @enderror
                    @error('horario_libre')
            ...
            <div class="col-sm-6 col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="time" wire:model.lazy="hora_fin" {{ $professor_id == 'Elegir' ? 'disabled' : '' }}>
                    @error('hora_fin')
                    <span class="text-danger er">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="n-chk text-center">
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="lunes">
                            <span class="new-control-indicator"></span>Lunes
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="martes">
                            <span class="new-control-indicator"></span>Martes
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="miercoles">
                            <span class="new-control-indicator"></span>Miercoles
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="jueves">
                            <span class="new-control-indicator"></span>Jueves
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="viernes">
                            <span class="new-control-indicator"></span>Viernes
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="sabado">
                            <span class="new-control-indicator"></span>Sabado
                        </label>
                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                            <input @if (!$hora_inicio && !$hora_fin) disabled @endif type="checkbox" class="new-control-input" wire:model.lazy="domingo">
            ...
            <div class="col-sm-12 col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" wire:model.defer="costo_matricula" {{ $selected_id > 0 ? 'disabled' : '' }}>
            ...
            <div class="col-sm-12 col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" wire:model="costo_curso" {{ $selected_id > 0 ? 'disabled' : '' }}>
                    @error('costo_curso')
                    <span class="text-danger er">{{ $message }}</span>
                    @enderror
                </div>
    ...
    <x-slot name="footer">
        @if ($selected_id
        < 1) <x-button wire:click.prevent="Store()" wire:loading.attr="disabled" wire:target="Store" texto="GUARDAR" />
        @else
