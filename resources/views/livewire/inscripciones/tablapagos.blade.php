                    ...
                    <tbody>
                        @forelse ($pagosAlumno as $pago)
                            <tr
                                ...
                                <td class="text-center">
                                    <span>
                                        <img src="{{ asset('storage/pagos/' . $pago->comprobante) }}"
                                            alt="imagen de ejemplo" height="80" width="100" class="rounded">
                                    </span>
                                    @if ($pago->comprobante)
                                        <x-button wire:click="export('{{ $pago->comprobante }}')" texto="Descargar"
                                            color="primary">
